...
def z1():
    ...
    cityField.place(relx=0.15, rely=0.30, relwidth=0.7, relheight=0.1)
    cityField.pack()
    btn = Button(frame_top, text='Узнать температуру', command=w)
    btn.place(relx=0.20, rely=0.55, relwidth=0.4, relheight=0.4)
    btn.pack()
